...
const COLOR_STYLES = {
  emerald: {
    ...
    score:  'border-emerald-200 bg-emerald-500/10 text-emerald-600 dark:border-emerald-800/50 dark:text-emerald-400',
  ...
  blue: {
    ...
    score:  'border-blue-200 bg-blue-500/10 text-blue-600 dark:border-blue-800/50 dark:text-blue-400',
  ...
  amber: {
    ...
    score:  'border-amber-200 bg-amber-500/10 text-amber-600 dark:border-amber-800/50 dark:text-amber-400',
  ...
  red: {
    ...
    score:  'border-red-200 bg-red-500/10 text-red-600 dark:border-red-800/50 dark:text-red-400',
  ...
  return (
    <section className="rounded-2xl border border-slate-200/60 bg-white/90 p-6 shadow-xl backdrop-blur-xl sm:p-8 dark:border-white/[0.08] dark:bg-slate-900/80">
      ...
      <div className={`mb-6 flex items-center gap-5 rounded-xl border px-5 py-4 ${s.wrap}`}>
        <div className={`flex h-16 w-16 shrink-0 flex-col items-center justify-center rounded-xl border ${s.score}`}>
          <span className={`text-2xl font-black leading-none ${s.label}`}>{analysis.ats_score}</span>
          <span className={`text-[10px] font-bold uppercase tracking-widest opacity-60 ${s.label}`}>/100</span>
        </div>
        <div>
